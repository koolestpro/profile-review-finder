      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="max-w-sm">
          <h1 className="text-xl font-bold tracking-tight text-brand-ink">
            Find Your Google Maps Listing
          </h1>
          <p className="mt-2 text-sm leading-relaxed text-brand-ink/80">
            Use our Google Maps listing finder to select your Google business listing,
            ensuring your plaque is set up correctly before it arrives!
          </p>
        </div>
          ...
          >
            <div className="mb-2 flex items-center justify-center">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-brand-soft px-3 py-1 text-xs font-medium text-brand-ink">
                ...
                {profile.location ? "1 of 1 products selected" : "No listing selected yet"}
              </span>
            </div>
